...
public class MSSetting : MonoBehaviour
{
    public static MSSetting instance;
    ...
    {
        if (a_music != null && StaticHelper.music.Equals(1))
            a_music.Play();
    }
    ...
    {
        if (a_sound != null && StaticHelper.sound.Equals(1))
