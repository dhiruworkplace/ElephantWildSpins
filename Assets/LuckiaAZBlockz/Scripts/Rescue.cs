...
public class Rescue : MonoBehaviour 
{
	...
	{
		//if (InputManager.Instance.canInput() && !AdsController.instance.videoBuild)
		//{
		//	// Call your ad network to show the rewarded video ad
		//	AdsController.instance.ShowAd(AdNetwork.ADMOB, AdType.REWARDED, OnAdRewarded);
		//}
	}

	private void OnAdRewarded()
	{
		// Rewarded video has been fully watched.
		GamePlay.Instance.OnRescueDone(true);
		gameObject.Deactivate();
	}
